...
(function() {
  ...
  document.addEventListener("click", function(e) {
    ...
    if (ctaType === "call") {
      bump(5);
      track("cion_call_click", { cta_type: "Call", cta_position: ctaPos, intent: ctaIntent, session_score: window.cionScore });
    } else if (ctaType === "whatsapp") {
      bump(5);
      track("cion_whatsapp_click", { cta_type: "WhatsApp", cta_position: ctaPos, intent: ctaIntent, session_score: window.cionScore });
