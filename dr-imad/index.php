...
<section class="hero-home">
  ...
  <div class="hero-text-panel">
    ...
    <h1 class="hero-h1">
      <span class="te-content">"Surgery possible కాదు" అని చెప్పారా? <em>ముందు నాకు మీ reports చూపించండి.</em></span>
      <span class="en-content">If you&rsquo;ve been told surgery isn&rsquo;t possible, <em>show me your reports first.</em></span>
    </h1>
    <p class="hero-lede">
      <span class="te-block">M.Ch AIIMS. ESSO Fellow, Hannover. GI మరియు peritoneal cancer surgery లో 14+ years.</span>
      <span class="en-block">M.Ch AIIMS. ESSO Fellow, Hannover. 14+ years in GI and peritoneal cancer surgery.</span>
    </p>
    <div class="hero-ctas">
